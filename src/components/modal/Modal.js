...
const variantIcons = {
  default: null,
  info: <IconInfoCircle tw='stroke-current text-blue-500 mr-2' />,
  warning: <IconAlertTriangle tw='stroke-current text-yellow-500 mr-2' />,
  danger: <IconAlertTriangle tw='stroke-current text-red-500 mr-2' />,
      ...
      >
        ...
        >
          <div className='inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-xl'>
            ...
            {footer && <div className='mt-6'>{footer(close, focusRef)}</div>}
          </div>
        </Transition.Child>
      </Dialog>
    </Transition>
